...
public class DatabaseDummyData {
	...
	public static void init() {
		...
		RouterModelDAO rmdao = new RouterModelDAO();
		RouterModelServiceImplementation rms = new RouterModelServiceImplementation(rmdao);
		InterfacesModelDAO imsdao = new InterfacesModelDAO();
		InterfacesModelServiceImplementation ims = new InterfacesModelServiceImplementation(imsdao);
		LoginModelDAO lmdao = new LoginModelDAO();
		LoginModelServicesImplementation lms = new LoginModelServicesImplementation(lmdao);
		FeaturesModelDAO fmsdao = new FeaturesModelDAO();
		FeaturesModelServiceImplementation fms = new FeaturesModelServiceImplementation(fmsdao);
